...
class print_customer_statement(models.AbstractModel):
    ...
    def set_ageing(self, obj):
        ...
        d4 = '(Al) ' + self.get_month_name(d4.day, d4.month, d4.year)
    ...
    def get_lines(self, partner):
        ...
        if move_lines:
            for line in move_lines:
                ...
                # MAVE: Quitar la condición para incluir todos los movimientos del rango de fechas,
                # para mostrar los que estén con saldo 0.

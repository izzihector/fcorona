...
class PosOrder(models.Model):
    ...
    def create_invoice_from_pos_orders(
        ...
        if l10n_mx_edi_is_global_invoice:
            product_uom_activity = self.env.ref('cnd_pos_multi_order_invoice.product_uom_activity')
            product_product_sell = self.env.ref('cnd_pos_multi_order_invoice.product_product_sell')
